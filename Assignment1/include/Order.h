...
class Order {
    ...
    public:
        ...
        int getDistance() const; //Return the order distance
        string orderStatusToString() const; //Convert OrderStatus enum to string       
        void advanceStatus(); //Advance the order status to the next stage
    ...
    private:
        ...
        std::string volunteerIdToString(int volunteerId) const; //Convert volunteerId to string
};