...
//Enum representing the role of the volunteer
enum class volunteerRole{
    COLLECTOR,
    DRIVER,
    LIMITED_COLLECTOR,
    LIMITED_DRIVER
...
class Volunteer {
    public:
        ...
        string volunteerStatus(int timeLeft, int ordersLeft) const; // Provides formatted status of the volunteer
        virtual volunteerRole getVolunteerRole() const = 0; //Returns an enum representing volunteers role
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        volunteerRole getVolunteerRole() const override;  //**explain
...
class LimitedCollectorVolunteer: public CollectorVolunteer {
    ...
    public:
        ...
        volunteerRole getVolunteerRole() const override;
